var rule = {
    title:'6V新版[磁]',
    host:'https://www.xb6v.com',  // 🔧 修复1: HTTP→HTTPS
    url: '/fyclass/index_fypage.html[/fyclass/]',  // 🔧 修复2: 第1页用 /fyclass/
    filter_url:'{{fl.class}}',
    filter:{
    ...
    timeout:5000,
    class_parse:'#menus&&>li:gt(1):lt(20);a&&Text;a&&href;.*/(.*)/',  // 🔧 修复3: >li排除子菜单
    cate_exclude:'国剧|短剧|日韩剧|欧美剧|旧版6v|留言|求片|标签|关于',
    play_parse:true,
    limit:6,
    推荐: '*',  // ✅ 保持 * 启用推荐
    一级: '#post_container&&li;h2&&Text;img&&src;.info_date&&Text;a&&href',  // ✅ 老版本规则正确
    二级: {
